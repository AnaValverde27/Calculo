<%@ Page Title="Coseno" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Coseno.aspx.cs" Inherits="calculo.Coseno" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:Button ID="calcularButton" runat="server" Text="Calcular" OnClick="CalcularCoseno_Click" />
        <br />
